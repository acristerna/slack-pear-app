...
app.view('view_1', async ({ ack, body, view, client, logger }) => {
  ...
  const channelID = providedValues.target_channel.target_select.selected_conversation;
  ...
  const challenges = view.state.values.challenges["plain_text_input-action"].value;
  const goals = view.state.values.goals["plain_text_input-action"].value;
  const users_selected = view.state.values.users_selected["multi_users_select-action"].selected_users;
